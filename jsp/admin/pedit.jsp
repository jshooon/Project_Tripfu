...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/css/admin/pedit.css">
    </head>
    <body>
...
<!-- 사이드바 끝 -->
            ...
            <!-- 본문 들어가는 부분 시작 -->
		 		<h2 class = "title">패키지상품 수정</h2>
            <form id = "pupdateForm" class="form-horizontal" role="form" onsubmit = "return pupdate();">
            	<input type="hidden" class="form-control" id = "pnum" name ="pnum" value = "${pproduct.pnum}" >
                <div class="form-group" id="divEmail">
                	<div class = "c">
                    	<label for="pname" class="col-lg-2 control-label">상품명</label>
                    <div id = "ediv" class="col-lg-8" >
                        <input type="text" class="form-control" id = "pname" name ="pname" value = "${pproduct.pname}" required>
                    </div>
                    </div>
                </div>
                <div class="form-group" id="divEmail">
                    ...
                    <div id = "ediv" class="col-lg-8" >
                        <input type="text" class="form-control" id = "area" name ="area" value = "${pproduct.area}"required>
                    </div>
                    </div>
                </div>
                <div class="form-group" id="divEmail">
                    ...
                    <div id = "ediv" class="col-lg-8" >
                        <input type="text" class="form-control" id = "type" name ="type" value = "${pproduct.type}" required>
                    </div>
                    </div>
                </div>
                <div class="form-group" id="divEmail">
                    ...
                    <div id = "ediv" class="col-lg-8" >
                        <input type="text" class="form-control" id = "price" name ="price" value = "${pproduct.price}" required>
                    </div>
                    </div>
                </div>
                <div class="form-group" id="divEmail">
                    ...
                    <div id = "ediv" class="col-lg-8" >
                        <input type="date" class="form-control" id = "sdate" name ="sdate" value = "${pproduct.sdate}" required>
                    </div>
                    </div>
                </div>
                <div class="form-group" id="divEmail">
                    ...
                    <div id = "ediv" class="col-lg-8" >
                        <input type="date" class="form-control" id = "edate" name ="edate" value = "${pproduct.edate}" required>
                    </div>
                    </div>
                </div>
                <div class="form-group" id="divEmail">
                    ...
                    <div id = "ediv" class="col-lg-8" >
                        <input type="text" class="form-control" id = "fname" name ="fname" value = "${pproduct.fname}" required>
                    </div>
                    </div>
                </div>
                <div class="form-group" id="divEmail">
                    ...
                    <div id = "ediv" class="col-lg-8" >
                        <input type="text" class="form-control" id = "ifname" name ="ifname" value = "${pproduct.ifname}" required>
                    </div>
                    </div>
                </div>
                <div class="form-group" id="divEmail">
                    ...
                    <div id = "ediv" class="col-lg-8" >
                        <input type="text" class="form-control" id = "pnump" name ="pnump" value = "${pproduct.pnump}" required>
                    </div>
                    </div>
                </div>
                <div class="form-group" id="divEmail">
                    ...
                    <div id = "ediv" class="col-lg-8" >
                        <input type="text" class="form-control" id = "ptitle" name ="ptitle" value = "${pproduct.ptitle}" required>
                    </div>
                    </div>
                </div>
                <div class="form-group" id="divEmail">
                    ...
                    <div id = "ediv" class="col-lg-8" >
                        <textarea class="form-control" id = "pcontents" name ="pcontents" required>${pproduct.pcontents}</textarea>
                    </div>
                    </div>
                </div>                
            ...
            <!--// 푸터 들어가는 부분 -->
        <script src="/js/admin/pedit.js"></script>

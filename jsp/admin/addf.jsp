...
<html>
    <head>
		...
		<link rel="stylesheet" type="text/css" href="/css/admin/addf.css">
    </head>
    <body>
...
<!-- 네비바 끝 -->
            ...
            <!-- 본문 들어가는 부분 시작 -->
		 		<h2 class = "title">자유상품 등록</h2>
            <form id = "addfForm" class="form-horizontal" role="form" onsubmit = "return addfProduct();">
            ...
            <!--// 푸터 들어가는 부분 -->
		<script src="/js/admin/addf.js"></script>
